...
<t:layout title="Contacts" context="${pageContext.servletContext.contextPath}">
    <jsp:body>
        ...
        <form:form method="post" modelAttribute="contact" action="${pageContext.servletContext.contextPath}/contacts"
            commonName="contact">
            ...
            <spring:bind path="organisation.id">
                <div class="form-group">
                    ...
                    <form:select id="organisationId" path="organisation.id" cssClass="form-control">
                        <form:option value="-1" label="--" />
                        <form:options items="${organisations}" itemValue="id" itemLabel="displayInfo" />
                    </form:select>
                </div>
            </spring:bind>
            ...
            <div class="form-group">
                ...
                <a class="btn btn-info" href="${pageContext.servletContext.contextPath}/contacts/${contact.id}">
                    Cancel
                </a>
            </div>
        </form:form>
